...
public struct ModifierListSyntax: _SyntaxBase {
  ...
  public func appending(
    _ syntax: Syntax) -> ModifierListSyntax {
    var newLayout = data.raw.layout
    newLayout.append(syntax.raw)
    return replacingLayout(newLayout)
  }
...
public struct ElseifDirectiveClauseListSyntax: _SyntaxBase {
  ...
  /// Creates a new `ElseifDirectiveClauseListSyntax` by replacing the underlying layout with
  /// a different set of raw syntax nodes.
  ///
  /// - Parameter layout: The new list of raw syntax nodes underlying this
  ///                     collection.
  /// - Returns: A new `ElseifDirectiveClauseListSyntax` with the new layout underlying it.
  internal func replacingLayout(
    _ layout: [RawSyntax?]) -> ElseifDirectiveClauseListSyntax {
    let newRaw = data.raw.replacingLayout(layout)
    let (newRoot, newData) = data.replacingSelf(newRaw)
    return ElseifDirectiveClauseListSyntax(root: newRoot, data: newData)
  }
  ...
  public func appending(
    _ syntax: ElseifDirectiveClauseSyntax) -> ElseifDirectiveClauseListSyntax {
    var newLayout = data.raw.layout
    newLayout.append(syntax.raw)
    return replacingLayout(newLayout)
  }
  ...
  ///
  /// - Returns: A new `ElseifDirectiveClauseListSyntax` with that element appended to the end.
  public func inserting(_ syntax: ElseifDirectiveClauseSyntax,
                        at index: Int) -> ElseifDirectiveClauseListSyntax {
    var newLayout = data.raw.layout
    /// Make sure the index is a valid insertion index (0 to 1 past the end)
    precondition((newLayout.startIndex...newLayout.endIndex).contains(index),
                 "inserting node at invalid index \(index)")
  ...
  ///            removed.
  public func removing(childAt index: Int) -> ElseifDirectiveClauseListSyntax {
    var newLayout = data.raw.layout
    newLayout.remove(at: index)
    return replacingLayout(newLayout)
  }
  ...
  public func removingFirst() -> ElseifDirectiveClauseListSyntax {
    var newLayout = data.raw.layout
    newLayout.removeFirst()
    return replacingLayout(newLayout)
  }
  ...
  public func removingLast() -> ElseifDirectiveClauseListSyntax {
    var newLayout = data.raw.layout
    newLayout.removeLast()
    return replacingLayout(newLayout)
  }
  ...
  /// Returns an iterator over the elements of this syntax collection.
  public func makeIterator() -> ElseifDirectiveClauseListSyntaxIterator {
    return ElseifDirectiveClauseListSyntaxIterator(collection: self)
  }
}
...
extension ElseifDirectiveClauseListSyntax: Collection {
  ...
  public subscript(_ index: Int) -> ElseifDirectiveClauseSyntax {
    return child(at: index)! as! ElseifDirectiveClauseSyntax
  }
}
...
public struct ElseifDirectiveClauseListSyntaxIterator: IteratorProtocol {
  public typealias Element = ElseifDirectiveClauseSyntax

  private let collection: ElseifDirectiveClauseListSyntax
  private var index: ElseifDirectiveClauseListSyntax.Index

  fileprivate init(collection: ElseifDirectiveClauseListSyntax) {
    self.collection = collection
    self.index = collection.startIndex
  }
...
public struct SwitchCaseListSyntax: _SyntaxBase {
  ...
  public func appending(
    _ syntax: SwitchCaseSyntax) -> SwitchCaseListSyntax {
    var newLayout = data.raw.layout
    newLayout.append(syntax.raw)
    return replacingLayout(newLayout)
  }
  ...
  ///
  /// - Returns: A new `SwitchCaseListSyntax` with that element appended to the end.
  public func inserting(_ syntax: SwitchCaseSyntax,
...
extension SwitchCaseListSyntax: Collection {
  ...
  public subscript(_ index: Int) -> SwitchCaseSyntax {
    return child(at: index)! as! SwitchCaseSyntax
  }
}
...
public struct SwitchCaseListSyntaxIterator: IteratorProtocol {
  public typealias Element = SwitchCaseSyntax
