...
internal func makeSyntax(root: SyntaxData?, data: SyntaxData) -> Syntax {
  ...
  case .elseifDirectiveClause:
    return ElseifDirectiveClauseSyntax(root: root, data: data)
  case .ifConfigDecl:
  ...
  case .elseifDirectiveClauseList:
    return ElseifDirectiveClauseListSyntax(root: root, data: data)
  case .elseDirectiveClause:
    return ElseDirectiveClauseSyntax(root: root, data: data)
